...
void Drive::control_arcade(){
  ...
  /*
 float fwd = Remote.Axis3.position() * -1;
 float sideways = Remote.Axis1.position();
 float rightTrain = fwd + sideways;
 float leftTrain = 1 - sideways;

 rightFrontMotor.setVelocity(rightTrain, pct);
 rightMiddleMotor.setVelocity(rightTrain, pct);
 rightBackMotor.setVelocity(rightTrain, pct);
 leftFrontMotor.setVelocity(leftTrain, pct);
 leftMiddleMotor.setVelocity(leftTrain, pct);
 leftBackMotor.setVelocity(leftTrain, pct);
